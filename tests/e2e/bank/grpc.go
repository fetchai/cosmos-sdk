...
func (s *E2ETestSuite) TestTotalSupplyGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			&types.QueryTotalSupplyResponse{
				Supply: sdk.NewCoins(
					...
					sdk.NewCoin(s.cfg.BondDenom, s.cfg.StakingTokens.Add(math.NewInt(2))),
				),
		...
		},
		{
			...
			&types.QuerySupplyOfResponse{
				Amount: sdk.NewCoin(s.cfg.BondDenom, s.cfg.StakingTokens.Add(math.NewInt(2))),
			},
		},
		{
			"Query for `height` > 1",
			...
			&types.QuerySupplyOfResponse{},
			&types.QuerySupplyOfResponse{
				Amount: sdk.NewCoin(s.cfg.BondDenom, s.cfg.StakingTokens.Add(math.NewInt(4))),
			},
		},
		{
