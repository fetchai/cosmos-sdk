...
replace (
	...
	//// Fix GHSA-p22h-3m2v-cmgh vulnerability: Cosmos SDK's Integer Overflow vulnerability in its Validator Rewards pool can
	//// cause a chain halt
	//// https://github.com/advisories/GHSA-p22h-3m2v-cmgh
	//replace github.com/cosmos/cosmos-sdk => github.com/cosmos/cosmos-sdk v0.53.7
	github.com/cosmos/cosmos-sdk => ../../.
	// Fix for following 2 vulnerabilities:
	// CVE-2025-8959: HashiCorp go-getter Vulnerable to Symlink Attacks
	// https://github.com/advisories/GHSA-wjrx-6529-hcj3
	// CVE-2026-4660: HashiCorp's go-getter library may allow arbitrary file reads
	// https://github.com/advisories/GHSA-92mm-2pjq-r785
	github.com/hashicorp/go-getter => github.com/hashicorp/go-getter v1.8.6
