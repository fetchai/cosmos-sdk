...
func TestRandomizedGenState(t *testing.T) {
	...
	dec1, _ := math.LegacyNewDecFromStr("0.940000000000000000")

	require.Equal(t, uint64(6311520), mintGenesis.Params.BlocksPerYear)
	require.Equal(t, dec1, mintGenesis.Params.InflationRate)
	...
	require.Equal(t, "0.940000000000000000", mintGenesis.Minter.NextInflationRate(mintGenesis.Params).String())
