...
func (s *CLITestSuite) TestPrepareConfigForTxCreateValidator() {
	...
	tests := []struct {
	...
	}{
		{
			name:        "all defaults",
			fsModify:    func(fs *pflag.FlagSet) {},
			expectedCfg: mkTxValCfg(cli.DefaultTokens.String()+sdk.DefaultBondDenom, "0.1", "0.2", "0.01", "1000000000000000000"),
		},
		{
			name: "Custom amount",
			fsModify: func(fs *pflag.FlagSet) {
		...
		},
		{
			...
			expectedCfg: mkTxValCfg(cli.DefaultTokens.String()+sdk.DefaultBondDenom, "0.54", "0.2", "0.01", "1000000000000000000"),
		},
		{
			...
			expectedCfg: mkTxValCfg(cli.DefaultTokens.String()+sdk.DefaultBondDenom, "0.1", "0.89", "0.01", "1000000000000000000"),
		},
		{
			...
			expectedCfg: mkTxValCfg(cli.DefaultTokens.String()+sdk.DefaultBondDenom, "0.1", "0.2", "0.55", "1000000000000000000"),
		},
		{
