...
// DefaultCommission constructs a commission rates with minimum rates.
func DefaultCommission() stakingtypes.CommissionRates {
	return stakingtypes.NewCommissionRates(*stakingtypes.DefaultMinCommissionRate, *stakingtypes.DefaultMinCommissionRate, sdk.ZeroDec())
}
