...
Example:
$ %s query gov proposals --depositor fetch1skjwj5whet0lpe65qaq4rpq03hjxlwd9q5cpap
$ %s query gov proposals --voter fetch1skjwj5whet0lpe65qaq4rpq03hjxlwd9q5cpap
...
Example:
$ %s query gov deposit 1 fetch1skjwj5whet0lpe65qaq4rpq03hjxlwd9q5cpap
`,
				version.AppName,
			),
		),
